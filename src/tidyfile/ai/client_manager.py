...
class AIClientManager:
    ...
    def __init__(self, config_file: str = None):
        ...
        try:
            ...
            self.config_file = str(app_paths.ai_config_file)
        except ImportError:
            # 兼容旧版本
            self.config_file = config_file or "ai_models_config.json"
    ...
    def create_default_config(self):
        """创建默认配置"""
        self.models = [
            ModelConfig('qwen-long', 'Qwen-Long在线模型', 'https://dashscope.aliyuncs.com/compatible-mode/v1', 'qwen-long', 'qwen_long', '', 1, False),  # API密钥需要用户自行配置
